<?php
	...
	';
	$scripts = '<script src="public/js/password.js" defer></script>';
	$meta = '';
?>

<?php ob_start(); ?>

<main id="sign-in" class="wrap">
	<div>
		<div>
			<h1>Connexion</h1>
			...
			<form method="POST" action="">
				...
				<div>
					<a id="form-links" href="<?= ROOT?>inscription">Créer une équipe</a>
					<a id="form-links" href="">Mot de passe oublié ?</a>
				</div>
			</form>
		</div>
	</div>
